    ...
    <div class="container">
        <asp:Repeater ID="rpt_hienThiSanPham" runat="server" OnItemCommand="rpt_hienThiSanPham_ItemCommand">
            <ItemTemplate>
               ...
               <div class="products">
                         <figure><img src="../../public/images/<%# Eval("HinhAnh") %>" class="img_product" /></figure>
                         <h2><%# Eval("TenSP") %></h2>
                         <p><%# Eval("DonGia", "{0:000,000}")%></p>
                        <button class="btn_pro"><a href="../chi-tiet-san-pham/chitietsp.aspx/?masp=<%# Eval("MaSP") %>">Chi Tiết</a></button>
                </div>
            </div>
            </ItemTemplate>
        </asp:Repeater>
